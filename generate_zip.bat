...
mkdir Lebas__Ronan
mkdir Lebas__Ronan\Lebas__Ronan

REM Copy the directories into it
xcopy /E /I cpp Lebas__Ronan\Lebas__Ronan\cpp
xcopy /E /I swing Lebas__Ronan\Lebas__Ronan\swing
xcopy /E /I docs Lebas__Ronan\Lebas__Ronan\docs

REM Convert the README to PDF
pandoc README.md -s -o README.html

REM Copy the PDF into the directory
copy README.html Lebas__Ronan\Lebas__Ronan\
